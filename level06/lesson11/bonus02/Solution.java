...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        name = reader.readLine();
        Cat father = new Cat(name, grandFather);
        name = reader.readLine();
        Cat mother = new Cat(name, null ,grandMother);
        name = reader.readLine();
        Cat son = new Cat(name, father ,mother);
        name = reader.readLine();
        Cat daughter = new Cat(name, father, mother);
...
/*        public String toString()
        {
            ...
            {
                if ((mother != null) && (father == null)) return "Cat name is " + name + ", mother is " + mother.name + ", no father";
                if ((mother == null) && (father != null)) return "Cat name is " + name + ", no mother " + ", father is " + father.name;
